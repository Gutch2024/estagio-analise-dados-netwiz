...
- **`3-cursos_mesma-universidade_amostra.csv`** — Amostra de 3 cursos (dados de exemplo) usada na primeira etapa de validação do modelo, até o ficheiro ser aceite sem erros.
- **`Verificacao_53colunas_16cursos_Piaget-Catolica.xlsx`** — Matriz de verificação das 53 colunas para 16 cursos do Instituto Piaget e da Universidade Católica, com os campos assinalados e a explicação de cada coluna.

...
- **`Tarefa3_Pesquisa-qualificacao-clientes_PT-ES.pdf`** — Enunciado/relatório da tarefa.
- **`Base_50-clientes-qualificados_PT-ES.xlsx`** — Base das 50 entidades qualificadas (20 PT + 30 ES), com setor, cidade, website, contactos públicos, redes sociais, oportunidade, motivo e prioridade.

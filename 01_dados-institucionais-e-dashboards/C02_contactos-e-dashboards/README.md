...
## Notas
- O ficheiro-fonte com os contactos e o modelo Power BI **não são anexados** por conterem dados pessoais (RGPD).
- Redação aplicada nesta versão pública: **remoção das páginas 7, 8 e 10** (nomes de colaboradoras).

...
## Notas
- Base legal declarada na metodologia: **interesse legítimo para prospeção B2B** — dados de empresas/organizações, não de pessoas singulares.
- Redação aplicada nesta versão pública: **nomes de 2 colaboradores** anonimizados na folha de metodologia.

...
## Contexto
Segunda tarefa do conjunto, aplicada sobre a base da C.17. O desenho do sistema de pontuação foi do estagiário.

## 📎 Evidências — clica para abrir ou descarregar

- **[📊 Descarregar o Excel → «NetWiz_P2_Scorecard-Maturidade-Digital.xlsx»](https://github.com/Gutch2024/estagio-analise-dados-netwiz/raw/main/06_carteira-de-prospecao-comercial/C18_scorecard-maturidade-digital-p2/NetWiz_P2_Scorecard-Maturidade-Digital.xlsx)**  
  Scorecard com critérios, pesos e limiares parametrizados, resumo por setor e folha de metodologia.
